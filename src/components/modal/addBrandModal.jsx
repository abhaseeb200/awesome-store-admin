...
const AddBrandModal = ({
  ...
  const { createMutation, updateMutation } = useBrand(false);
  ...
  const form = useForm({
    defaultValues: {
      ...
      thumbnail: updateBrand?.thumbnail,
    },
    validators: {
    ...
    onSubmit: async ({ value }) => {
      if (isUpdate) {
        let mergedWithId = { value, id: updateBrand?._id };
